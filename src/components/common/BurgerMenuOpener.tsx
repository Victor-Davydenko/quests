...
interface IBurgerMenuOpener {
  handler: () => void,
}
const BurgerMenuOpener: FC<IBurgerMenuOpener> = ({ handler }) => {
  return (
    <button aria-label='menu_opener' onClick={handler} className='absolute right-5 top-11 md:hidden'>
...
export default BurgerMenuOpener;
